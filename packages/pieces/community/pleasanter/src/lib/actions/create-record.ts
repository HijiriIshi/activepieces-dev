...
import { attachmentsCreateHash } from '../common/attachments';
...
export const createRecord = createAction({
  ...
  async run(context) {
    const {
      ...
      classHash, numHash, dateHash, descriptionHash, checkHash, attachments
    } = context.propsValue;
    ...
    setIfExists(params, 'AttachmentsHash', attachmentsCreateHash.buildHash(attachments));
